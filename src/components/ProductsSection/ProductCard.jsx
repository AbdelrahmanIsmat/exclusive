      ...
      <div className="flex items-center gap-1">
        ...
        <div className="px-8 py-4">
          <DialogPrimitive
            title="Review"
            triggerComponent={
              <button className="p-1 bg-gray-100 rounded-lg cursor-pointer text-heading-m text-main-purple flex w-full items-center gap-4">
                REVIEW
              </button>
            }
          >
            <form className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 mt-3">
                ...
                <textarea
                  ...
                  className="border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-1 focus:ring-yellow-400"
                />
              </div>
              {/* Star Rating */}
              <div className="flex items-center gap-1">
